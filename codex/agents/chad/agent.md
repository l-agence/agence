...
- **Flavor**: Rude, direct, sarcastic
- **Expertise**: Cloud, CI/CD, reliability, cost optimization

---

**Token Cost**: ~10 tokens (lowest-cost LLM)
**Latency**: ~3-5s
**Best For**: Quick infra reviews, CI/CD troubleshooting
**Cost/query**: ~$0.005
